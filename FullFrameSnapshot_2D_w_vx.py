...
def plot_2D_frame(dir, plot_dir, start_nr, end_nr, xy=False, r_p=False, dvar='rho', zoom_level=None, vmin=None, vmax=None):
    ...
    for i in range(len(list)):
        ...
        cb = fig.colorbar(im, cax=cax, label='Vr[cm/s]', extend='both')
...
f = '0.05_DN_2D_V8_I5_100_e0.00'                                    # name of folder
...
plot_2D_frame(dir, plot_dir, start_nr, end_nr, xy=True, r_p=True, dvar='vel1', zoom_level=60, vmin=-3E7, vmax=3E7)
